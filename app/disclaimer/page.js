...
export default function Page() {
  return (
    <InfoPage eyebrow="Important information" title="Disclaimer" intro="Tooliyapa provides convenient document utilities, but users should decide whether each result is appropriate for their needs." lastUpdated="September 7, 2026">
      ...
      <InfoSection title="Questions"><p>For a question about this disclaimer, email <a className="font-medium text-teal-700 underline underline-offset-4 dark:text-teal-400" href="mailto:milsonavnu@gmail.com">milsonavnu@gmail.com</a>. For more detail about permitted use, see the Terms of Use; for data practices, see the Privacy Policy.</p></InfoSection>
    </InfoPage>
  )
}
