...
export default function Page() {
  return (
    <InfoPage eyebrow="Get in touch" title="Contact Tooliyapa" intro="Send an email when you have a question about Tooliyapa or want to report something that could make the website more useful or accurate.">
      ...
      <section aria-labelledby="email-tooliyapa" className="rounded-2xl border border-teal-200 bg-teal-50/70 p-6 dark:border-teal-900 dark:bg-teal-950/20 sm:p-8">
        ...
        <a className="mt-3 inline-flex break-all rounded-lg bg-teal-700 px-4 py-3 font-semibold text-white transition hover:bg-teal-800 focus:outline-none focus:ring-2 focus:ring-teal-700 focus:ring-offset-2 dark:focus:ring-offset-gray-950" href={`mailto:${email}`}>{email}</a>
